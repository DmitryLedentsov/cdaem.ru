...
<div class="payment-service">
    ...
    <div class="payment-way" <?php if (Yii::$app->user->isGuest): ?>style="display: block;"<?php endif; ?> data-target="pay-system">
        ...
        <div class="text-center pay-button" <?php if (Yii::$app->user->isGuest): ?>style="display: block;"<?php endif; ?>>
            <input type="submit" value="Оплатить" class="btn btn-orange"/>
        </div>
    </div>
