...
/* @var $model backend\modules\admin\models\LogSearch */
...
<?php $form = ActiveForm::begin([
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-md-4 col-sm-4 col-xs-12 col-lg-2"><?= $form->field($model, 'log_time')->widget(DatePicker::className(), [
