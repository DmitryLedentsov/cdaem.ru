...
<table class="row" width="100%" bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; text-align:left; border-spacing:0; max-width:100%;">
    ...
    <tr>
        <td style="padding-left:30px; padding-right:30px; padding-bottom:32px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777;">
            ...
            У <?=$fromWhom?> есть 24 ч , чтобы оспорить причину «незаезд». Если <?=$secondSide?> не ответил,значит все улуги выполнены
            в полном объёме и стороны не имеют, друг к другу притензий! Компенсация денежных средств за «незаезд»,будет произведена
            через 10 дней и пополнит баланс Вашего личного кабинета. Если в течени 24 ч, от <?=$fromWhom?> поступил ответ за
            «незаезд» ,то администрация сайта Сдаём.ру,  разбирает данную жалобу двух сторон и принимает решение  на своё
            усмотрение, оставляя за собой право - заблокировать личный кабинет, ограничить доступ к аккаунту обоих пользователей,
            также посчитать оплаченную услугу выполненной - без возврата денежных средств за услугу, что означает, выполнение
