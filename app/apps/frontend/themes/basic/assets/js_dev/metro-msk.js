// Получить идентификатор метро
function getMetroId(id) {

    var metro = {};

    /*
     metro['1_0'] = ; // Дмитровское шоссе (Люблинско-Дмитровская)
     metro['1_0'] = ; // Селигерская (Люблинско-Дмитровская)
     metro['1_0'] = ; // Верхние Лихоборы (Люблинско-Дмитровская)
     metro['1_0'] = ; // Окружная (Люблинско-Дмитровская)
     metro['1_0'] = ; // Фонвизинская (Люблинско-Дмитровская)
     metro['1_0'] = ; // Бутырская (Люблинско-Дмитровская)
     metro['1_0'] = ; // Челобитьево (Калужско-Рижская)
     metro['1_0'] = ; // Румянцево (Сокольническая)
     metro['1_0'] = ; // Технопарк (Замоскворецкая)
     metro['1_0'] = ; // Саларьево (Сокольническая)
     metro['1_0'] = ; // Хорошёвская (Филёвская)
     metro['1_0'] = ; // Котельники (Таганско-Краснопресненская)
     metro['1_0'] = ; // Шелепиха (Выставочная - Нижняя Масловка)
     metro['1_0'] = ; // Ходынское поле (Выставочная - Нижняя Масловка)
     metro['1_0'] = ; // Петровский парк (Выставочная - Нижняя Масловка)
     metro['1_0'] = ; // Нижняя Масловка (Выставочная - Нижняя Масловка)
     metro['1_0'] = ; // Волхонка (Калининская)
     metro['1_0'] = ; // Плющиха (Калининская)
     metro['1_0'] = ; // Кутузовский проспект (Калининская)
     metro['1_0'] = ; // Тимирязевская (Тимирязевская - Улица Сергея Эйзенштейна)
     metro['1_0'] = ; // Улица Милашенкова (Тимирязевская - Улица Сергея Эйзенштейна)
     metro['1_0'] = ; // Телецентр (Тимирязевская - Улица Сергея Эйзенштейна)
     metro['1_0'] = ; // Улица академика Королёва (Тимирязевская - Улица Сергея Эйзенштейна)
     metro['1_0'] = ; // Выставочный центр (Тимирязевская - Улица Сергея Эйзенштейна)
     metro['1_0'] = ; // Улица Сергея Эйзенштейна (Тимирязевская - Улица Сергея Эйзенштейна)
     */
