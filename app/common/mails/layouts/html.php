...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
    ...
    <tr>
        <td class="container" style="padding-left:5px; padding-right:5px; padding-bottom:20px; background-color:#e9e9e9;">
            ...
            <table class="row" width="800" height="150" bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" border="0" style="border-bottom: solid 7px #8DD9E2; background-image: url('<?=$domain?>/email-images/header.png'); background-repeat: no-repeat; border-collapse:collapse; text-align:left; border-spacing:0; max-width:100%;">
                <tr>
                    <td style="padding: 15px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:100%; text-align:center; color:#2c8fd6;" valign="top">
                        <div style="font-size:12px; line-height:100%;">
                            <a href="<?=$domain?>"><img class="banner" alt="header" src="<?=$domain?>/basic-images/logo.png" vspace="0" hspace="0" border="0" style="display:block;" /></a>
                        </div>
                    </td>
                </tr>
            </table>

            <table class="row" width="800" bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; text-align:left; border-spacing:0; max-width:100%;">
                <tr>
            ...
            <table class="row" width="800" bgcolor="#f4f4f4" align="center" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; text-align:left; border-spacing:0; max-width:100%;">
                <tr>
                    <td colspan="2" style="padding-top:25px; padding-left:30px; padding-right:30px; padding-bottom:25px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777; border-top:1px #dddddd dotted;">
                        <?=date('Y')?> <img alt="©" src="<?=$domain?>/email-images/copyright.png" border="0" height="12" width="11" style="vertical-align:-1px;" /> <a style="text-decoration:none; color:#2c8fd6;" href="<?=$domain?>"><?=$domain?></a>. Все права защищены.
