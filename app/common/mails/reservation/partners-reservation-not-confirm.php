...
<table class="row" width="100%" bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" border="0"
    ...
    <tr>
        <td class="title"
            ...
            Ваш счёт пополнен на <?= $funds ?> руб., по причине неподтверждения Заявки «ЗАБРОНИРОВАТЬ» №<?= $id ?>
            другой стороной!
        </td>
    </tr>
    <tr>
        <td style="padding-left:30px; padding-right:30px; padding-bottom:32px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777;">
            ...
            ?>
            Прошло более суток после Вашего подтверждения заявки, а <?= $notConfirm ?> так и не подтвердил бронирование.
            Поэтому мы вернули все Ваши потраченные средства.
