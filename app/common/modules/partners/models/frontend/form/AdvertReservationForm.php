...
use common\modules\partners\models\frontend\Calendar;
...
class AdvertReservationForm extends AdvertReservation
{
    ...
    public function rules()
    {
        return array_merge([
            ...
            ['email', 'unique', 'targetClass' => \common\modules\users\models\User::class, 'targetAttribute' => 'email'],
            ['phone', 'unique', 'targetClass' => \common\modules\users\models\User::class, 'targetAttribute' => 'phone'],
