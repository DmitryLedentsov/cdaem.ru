...
class AdvertReservation extends \common\modules\partners\models\AdvertReservation
{
    ...
    {
        return [
            'update' => [/* вот это вот не стоит редактировать 'user_id', 'landlord_id', 'advert_id',*/
    ...
    public function rules()
    {
        return [
            ...
            ['landlord_id', 'exist', 'targetClass' => \common\modules\users\models\User::class, 'targetAttribute' => 'id'],
            ['advert_id', 'exist', 'targetClass' => \common\modules\partners\models\Advert::class, 'targetAttribute' => 'advert_id'],
