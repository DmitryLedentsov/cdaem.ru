...
<div class="login-wrapper">
    ...
    <div class="well">
        <?= $form->beginField($model, 'username', ['options' => ['class' => 'has-feedback'] ]) ?>
            ...
            <?= Html::activeTextInput($model, 'username', ['class'=>'form-control']) ?><i class="icon-users form-control-feedback"></i>
            <?= Html::error($model, 'username', ['class' => 'help-block']) ?>
        <?= $form->endField() ?>

        <?= $form->beginField($model, 'password', ['options' => ['class' => 'has-feedback'] ]) ?>
            <?= Html::activeLabel($model, 'password') ?>
            <?= Html::activePasswordInput($model, 'password', ['class'=>'form-control']) ?><i class="icon-lock form-control-feedback"></i>
