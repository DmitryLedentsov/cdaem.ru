$(function() {
     ...
     * Раскрыть форму
     */
    $('#advertisement-multi-create-apartments-list input:checkbox').on('click', function (event) {
        var $this = $(this);
        checkedAction($this);
    });
     ...
     */
    $('#advertisement-multi-create-apartments-list input:checkbox').each(function( index ) {
        var $this = $( this );
        checkedAction($this);
    });
